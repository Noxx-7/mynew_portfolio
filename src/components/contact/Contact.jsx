...
const Contact = () => {
    ...
    const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_95goih5', 'template_hke2mwk', form.current, 'NZc5P8Ns2GHcHLe5A')
     e.target.reset()
  };
        ...
        <div className="contact content">
            ...
            <div className="contact__info">
                <motion.div variants={fadeIn('up', 'spring', 0.2, 1)} className="contact__card">
                    ...
                    <span className="contact__card-data">rahulnox7@gmail.com</span>
                ...
                <motion.div variants={fadeIn('up', 'spring', 0.4, 1)} className="contact__card">
                    ...
                    <span className="contact__card-data">@rahuldcrm</span>

                    <a href='https://twitter.com/rahuldcrm' target='_blank' className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                </motion.div>
                ...
                <i class="bx bxl-linkedin contact__card-icon"></i>
                    ...
                    <a href='https://www.linkedin.com/in/rahuldcrm/' target='_blank' className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                </motion.div>
